...
public class CChangeColor : CAction {
	
	// Use this for initialization
	// Use this for initialization
	public Sprite _TargetGameObjectSprite = null;
	...
	public void actionWith(Sprite pTargetObjectSprite, Color pEndColor,float pDuration)
	{
		_DestinationColor = new Vector4(pEndColor.r,pEndColor.g,pEndColor.b,pEndColor.a);
		_duration = pDuration;
		_TargetGameObjectSprite = pTargetObjectSprite;
	}
		
	override public void runAction()
	{
		if(_TargetGameObjectSprite == null)
		{
			Debug.Log("Missing target object in action script");
			return;
		}
		Color tStartColor = _TargetGameObjectSprite.color;
	...
	override public void setCompletion(float completion)
	{
		...
		mColor.a = mvColor4d.w;
   		_TargetGameObjectSprite.SetColor(mColor);
	}
